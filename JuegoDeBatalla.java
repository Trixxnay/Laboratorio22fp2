...
public class JuegoDeBatalla {
    ...
    public void mostrarPosicionesSoldados(Ejercito ejercitoOponente) {
        System.out.println("Posiciones de los soldados del ejercito oponente:");
        for (Soldado soldado : ejercitoOponente.getSoldados()) {
            System.out.printf("%s esta en la posicion (%d, %d)%n",
    ...
    private void mostrarResultadoFinal(String ganador, Ejercito ejercito1, Ejercito ejercito2) {
        ...
        detallesEjercito1.setText("Ejercito de " + ejercito1.getNombreReino() + ":\n");
        ...
        detallesEjercito2.setText("Ejercito de " + ejercito2.getNombreReino() + ":\n");
        ...
        JRadioButton opcion1 = new JRadioButton("Historia del Ejercito Perdedor");
        JRadioButton opcion2 = new JRadioButton("Historia del Ejercito Vencedor");
        ...
        opcion1.addActionListener(e -> {
            ...
            JOptionPane.showMessageDialog(frame, 
                "El ejercito de " + perdedor + " sufrio una derrota devastadora. Los soldados, abatidos, regresaron a sus tierras con la carga de la derrota.\n"
                + "El reino ahora enfrenta tiempos dificiles, con luchas internas y un pueblo que clama por liderazgo en medio de la incertidumbre.\n"
                + "A pesar de ello, el ejército prometio fortalecerse y estar listo para futuras batallas.");
        });
        ...
        opcion2.addActionListener(e -> {
            ...
            JOptionPane.showMessageDialog(frame, 
                "El ejercito de " + vencedor + " se alzo con la victoria, ganando la gloria y el respeto de todos los reinos.\n"
                + "Los soldados fueron recibidos como heroes, y el reino florecio bajo el liderazgo de sus valientes combatientes.\n"
                + "La victoria marco el inicio de una era de prosperidad, consolidando su posicion como el poder dominante.");
        });
        ...
        botonAccion.addActionListener(e -> {
            ...
            switch (seleccion) {
                ...
                case "Historia" -> JOptionPane.showMessageDialog(frame, 
                  ...
                  + "Desde las frias tierras de los Reinos Escandinavos, pasando por los férreos Reinos Anglo-Sajones y el noble Reino de Asturias,\n"
                  + "hasta los imponentes dominios del Imperio Bizantino, el Imperio Carolingio y el Reino de los Bulgaros, las tensiones han alcanzado un punto critico.\n"
                  + "Cada reino busca consolidar su supremacia en un mundo dividido, utilizando estrategias militares, unidades especializadas y el dominio del territorio como sus principales armas.\n"
                  + "Las guerras han comenzado, y solo uno podra reclamar la hegemonia sobre estas tierras conflictivas.\n\n"
                  + "El campo de batalla ardia con la intensidad de la lucha, un escenario donde el destino de los reinos colisionaba con una ferocidad inigualable.\n"
                  + "Las espadas resonaban al encontrarse, las lanzas perforaban el aire con precision mortal, y el grito de los soldados se entremezclaba con el estruendo de los tambores de guerra.\n"
                  + "Las tierras, que una vez fueron simbolo de paz y prosperidad, ahora temblaban bajo el peso de la discordia.\n\n"
                  + "Desde el amanecer hasta el ocaso, los combatientes se enfrentaron en un duelo implacable, sus cuerpos agotados pero sus espiritus impulsados por un proposito que trascendia la supervivencia.\n"
                  + "No habia lugar para la duda ni para el arrepentimiento; cada decision, cada movimiento, era un eco de la resolucion y el sacrificio que los había llevado hasta alli.\n"
                  + "El aire estaba cargado de cenizas y sudor, y el suelo, salpicado por el esfuerzo de quienes no cederian ante la derrota.\n\n"
                  + "Pero en medio del caos, surgieron momentos de asombrosa humanidad: un guerrero que ayudaba a un camarada herido, un lider que inspiraba a su gente a seguir adelante, "
                  + "y una determinacion colectiva que se negaba a rendirse.\n"
                  + "La batalla no se trataba solo de victoria o derrota. Era un enfrentamiento que defina la esencia de cada reino, una lucha por preservar sus ideales, "
                  + "su historia y su lugar en un mundo que, tras este día, nunca volveria a ser el mismo.\n"
